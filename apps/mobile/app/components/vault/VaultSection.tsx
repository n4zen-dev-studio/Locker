...
export function VaultSection(props: VaultSectionProps) {
  const { filter, items, sort, viewMode, reducedMotion, onLayout, onChangeFilter, onChangeViewMode, onSortCycle, onOpenItem } =
    props;
  ...
  return (
    <Animated.View
      onLayout={onLayout}
      entering={reducedMotion ? undefined : FadeInUp.delay(120).duration(360)}
