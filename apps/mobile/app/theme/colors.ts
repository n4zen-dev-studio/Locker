...
export const colors = {
  ...
  vaultHub: {
    vaultHubBg: "#050209",
    vaultHubBgTint: "#160918",
    vaultHubSurface: "rgba(18, 12, 24, 0.72)",
    vaultHubSurfaceElevated: "rgba(25, 17, 33, 0.82)",
    vaultHubTextPrimary: "#FFF7FD",
    vaultHubTextSecondary: "#D4C6DB",
    vaultHubMuted: "#8F809A",
    vaultHubAccentPink: "#FF4DBA",
    vaultHubAccentPinkSoft: "#FF9ADB",
    vaultHubGlow: "rgba(255, 77, 186, 0.3)",
    vaultHubOrbCore: "#FF5DC1",
    vaultHubOrbOuter: "rgba(255, 77, 186, 0.16)",
    vaultHubChipActive: "rgba(255, 77, 186, 0.16)",
    vaultHubChipInactive: "rgba(255, 255, 255, 0.04)",
    vaultHubCard: "rgba(17, 12, 23, 0.86)",
    vaultHubBorderSubtle: "rgba(255, 255, 255, 0.08)",
  },
  calculator: {
